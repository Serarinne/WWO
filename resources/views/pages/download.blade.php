        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-6xl">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 text-center lg:text-left space-y-6">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-900/40 text-cyan-400 text-xs font-semibold border border-cyan-700/40 tracking-wide uppercase">
                        <span class="w-2 h-2 rounded-full bg-cyan-400 animate-pulse"></span>
                        Mobile Application Available
                    </div>
                    
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-none">
                        Bring the <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-500">{{ env('APP_NAME') }}</span> to Your Device
                    </h1>
                    
                    <p class="text-gray-400 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
                        Access thousands of premium Neverness to Everness wallpapers instantly. Enjoy faster loading, offline favorite storage, and push notifications for new wallpaper updates.
                    </p>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                        ...
                        <a href="https://play.google.com/store/apps/details?id=serarinne.ntewallpaper" target="_blank" rel="noopener noreferrer" 
                           class="inline-flex items-center gap-3 px-6 py-3 bg-gray-950 hover:bg-black text-white border border-gray-800 hover:border-cyan-500/50 rounded-xl transition-all shadow-lg group w-full sm:w-auto justify-center">
                            {{-- Play Store SVG Icon --}}
                            ...
                            <div class="text-left leading-tight">
                                <p class="text-[10px] text-gray-400 font-medium tracking-wider uppercase">GET IT ON</p>
                ...
                <div class="lg:col-span-5 flex justify-center relative">
                    {{-- Device Wrapper Glow --}}
                    <div class="absolute inset-0 bg-cyan-500/10 blur-3xl rounded-full scale-75 pointer-events-none"></div>

                    {{-- Phone Container --}}
                    <div class="relative w-[280px] h-[570px] sm:w-[300px] sm:h-[600px] bg-gray-950 border-[8px] border-gray-800 rounded-[40px] shadow-2xl overflow-hidden flex flex-col group hover:border-gray-700 transition-colors duration-500">
                        {{-- Speaker / Notch --}}
                        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-5 bg-gray-800 rounded-b-2xl z-30"></div>

                        {{-- Phone Screen Content Placeholder --}}
                        <div class="flex-grow bg-[#0f172a] relative z-10 flex flex-col overflow-hidden">
                            {{-- Mockup Top Banner --}}
                            <div class="h-44 bg-gradient-to-br from-cyan-950 to-gray-900 border-b border-gray-800 relative flex items-end p-4">
                        ...
                        <div class="absolute bottom-1 left-1/2 transform -translate-x-1/2 w-28 h-1 bg-gray-700 rounded-full z-30"></div>
                    </div>
                </div>
