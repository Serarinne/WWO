    ...
    <main class="flex-grow">
        ...
        <div class="relative bg-gray-900 border-b border-gray-800 overflow-hidden">
            <div class="absolute inset-0 z-0">
                <div class="absolute inset-0 bg-gradient-to-br from-cyan-900/30 to-gray-900 opacity-50 blur-3xl scale-110"></div>
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-10 relative z-10">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
                    ...
                    <div class="flex-shrink-0 relative group">
                        <div class="w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border-4 border-gray-800 shadow-2xl relative z-10 bg-gradient-to-br from-cyan-500/20 to-cyan-500/5 flex items-center justify-center">
                            <svg class="w-10 h-10 md:w-12 md:h-12 text-cyan-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <div class="flex-grow text-center md:text-left pt-1">
                        <div class="flex items-center justify-center md:justify-start gap-2 mb-2">
                            <span class="px-2 py-0.5 rounded bg-cyan-900/50 text-cyan-300 text-xs font-medium border border-cyan-700/50">Settings</span>
                        </div>
            ...
            <form action="{{ route('settings.update') }}" method="POST" class="w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-10">
                    ...
                    @foreach($availableRatings as $value => $info)
                        <label class="flex items-start gap-4 p-5 rounded-xl bg-gray-800 border border-gray-700 hover:bg-gray-750 hover:border-cyan-500/50 cursor-pointer transition-all group relative focus-within:ring-2 focus-within:ring-cyan-500/50 focus-within:border-transparent shadow-sm hover:shadow-md">
                            <div class="flex items-center mt-0.5 flex-shrink-0">
                                <input
                                    ...
                                    class="w-5 h-5 rounded text-cyan-500 bg-gray-900 border-gray-600 focus:ring-cyan-500 focus:ring-offset-gray-800 accent-cyan-500 cursor-pointer transition-colors"
                                />
                            </div>
                            <div class="flex-grow">
                                <div class="flex items-center gap-2.5 mb-1.5">
                                    <svg class="w-5 h-5 text-cyan-400 flex-shrink-0 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div class="pt-6 border-t border-gray-800 flex flex-col-reverse sm:flex-row items-center justify-end gap-4">
                    <a href="{{ route('home') }}" class="w-full sm:w-auto px-6 py-3 text-sm font-medium text-gray-400 hover:text-white bg-transparent hover:bg-gray-800 rounded-lg transition-colors text-center focus:outline-none focus:ring-2 focus:ring-gray-600">
                        Cancel
                    </a>
                    <button type="submit" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-800 hover:bg-gray-750 border border-gray-700 hover:border-cyan-500/50 text-white text-sm font-medium rounded-lg transition-all shadow-sm hover:shadow-cyan-500/10 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 group">
                        <svg class="w-4 h-4 text-cyan-400 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
